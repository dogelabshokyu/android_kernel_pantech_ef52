...
/*
  3'rd party IMS srvcc 지원. 52S는 미지원
*/
/*
...
/*
   ...
   MSM8974에서 발생한 현상이므로 이 모델에서는 undef 한다.
*/
/*
...
/*
   GPS requirement ( Debug Screen)
*/
#define FEATURE_SKT_CP_GPS_DEBUG_SCREEN
