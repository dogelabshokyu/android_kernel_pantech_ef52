...
//When airplane mode is invoked, don't try setup data call. timing issue.
#define FEATURE_SKY_DS_IMS_UNREGISTER_VT

#define FEATURE_SKY_DS_SET_ACCEPT_RA_DEFRTR_FOR_IPV6
...
//\kernel\net\ipv6\addrconf.c
#define CONFIG_SKY_DS_OPTIMIZE_IPV6_ASSIGNMENT_CRASH_FIX
...
// moved to CONFIG_SKY_DS_ACCEPT_SIP_LAGRE_PACKET in FEATURE_SKY_DS_KERNEL_CONFIG 
// nf_conntrack_sip.c
//#define FEATURE_SKY_DS_ACCEPT_SIP_LAGRE_PACKET

// moved to CONFIG_SKY_DS_TCP_INIFINITE_LOOP_BUG_FIX in FEATURE_SKY_DS_KERNEL_CONFIG 
// tcp_input.c
//#define FEATURE_SKY_DS_TCP_INIFINITE_LOOP_BUG_FIX

// moved to CONFIG_SKY_DS_CHANGE_RNDIS_MTU in FEATURE_SKY_DS_KERNEL_CONFIG 
//kernel/drivers/usb/gadget/rndis.c
//#define FEATURE_SKY_DS_CHANGE_RNDIS_MTU

// moved to CONFIG_SKY_DS_TETHER_MSS in FEATURE_SKY_DS_KERNEL_CONFIG 
//#define FEATURE_SKY_DS_TETHER_MSS

// moved to CONFIG_SKY_DS_VPN in FEATURE_SKY_DS_KERNEL_CONFIG 
//#define FEATURE_SKY_DS_VPN_FIX

// moved to CONFIG_SKY_DS_CTS_LOCALHOST in FEATURE_SKY_DS_KERNEL_CONFIG 
//#define FEATURE_SKY_DS_CTS_LOCALHOST

// moved to CONFIG_SKY_DS_BAM_ADAPTIVE_TIMER_OFF in FEATURE_SKY_DS_KERNEL_CONFIG
//kernel\arch\arm\mach-msm\bam_dmux.c
//#define FEATURE_SKY_DS_BAM_ADAPTIVE_TIMER_OFF

// moved to CONFIG_SKY_DS_DEFAULT_CONGESTION_CONTROL in FEATURE_SKY_DS_KERNEL_CONFIG
