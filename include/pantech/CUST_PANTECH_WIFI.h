...
/* 2014-07-17, added by KYSONG, add [VHT] in capability */
#define FEATURE_PS_WIFI_STA_REQ_KT_SCAN_RESULT_ADD_INFO
//define vendor in wifi_sim_mobility.c      #define FEATURE_PS_WIFI_STA_REQ_KT_SCAN_RESULT_ADD_INFO_KT
