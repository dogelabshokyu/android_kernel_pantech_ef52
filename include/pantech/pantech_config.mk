...
TARGET_BUILD_PROJECT=ef52s
TARGET_BUILD_BOARDVER=tp20
TARGET_PRODUCT_VER=V22

TARGET_BUILD_PRJ_NAME=$(shell echo $(TARGET_BUILD_PROJECT) | tr a-z A-Z)

TARGET_BUILD_MODEL_NAME=IM-A870S#
TARGET_BUILD_VER_PREFIX=S0218#

TARGET_BUILD_VERSION=$(TARGET_BUILD_VER_PREFIX)214# 14/12/19 
TARGET_BUILD_VERSION_HIDDEN=$(TARGET_BUILD_VERSION)# hidden version
TARGET_BUILD_FS_VER=51# android userdata ext4 filesystem version
TARGET_BUILD_NV_VER=47# mdm efs version
...
PANTECH_GLOBAL_FLAGS+= -DPANTECH_PRELOAD_CHECKSUM=3747776232
